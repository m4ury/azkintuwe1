...
return [
    ...
    'any_of'                 => ':attribute поле несапраўднае.',
    ...
    'contains'               => 'У полі :attribute адсутнічае неабходнае значэнне.',
    ...
    'doesnt_contain'         => ':attribute поле не павінна ўтрымліваць наступнага: :values.',
    ...
    'encoding'               => 'Поле :attribute павінна быць закадзіравана ў :encoding.',
    ...
    'in_array_keys'          => ':attribute поле павінна ўтрымліваць па меншай меры адзін з наступных клавіш: :values.',
    ...
    'prohibited_if_accepted' => ':attribute поле забаронена, калі прынята :other.',
    'prohibited_if_declined' => ':attribute поле забаронена, калі :other адмовіліся.',
